...
def pull_locations(client: noaa.NOAAClient | None = None):
    ...
    response = cast(json_responses.LocationsJSON, asyncio.run(client.get_locations()))
    ...
    response_id = asyncio.run(client.get_location_by_id(sample_id))
