...
AnyResponse = (RateLimitJSON | DatasetIDJSON | DatasetsJSON | DatacategoryIDJSON | DatacategoriesJSON | DatatypeIDJSON | DatatypesJSON | LocationcategoryIDJSON | LocationcategoriesJSON | LocationIDJSON | LocationsJSON | StationIDJSON | StationsJSON)
__all__ = ["RateLimitJSON", "DatasetIDJSON", "DatasetsJSON", "DatacategoryIDJSON", "DatacategoriesJSON", "DatatypeIDJSON", "DatatypesJSON", "LocationcategoryIDJSON", "LocationcategoriesJSON", "LocationIDJSON", "LocationsJSON", "StationIDJSON", "StationsJSON", "AnyResponse"]
